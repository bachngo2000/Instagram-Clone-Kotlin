...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            // grab the description that that have inputted
            ...
            if (photoFile != null) {
                ...
                Log.e(TAG, "Error with photo file")
                //TODO Show a toast to the user to let them know how to take a picture
                Toast.makeText(this, "Capture an image by clicking on the Take Picture button!", Toast.LENGTH_SHORT).show()
            }
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                // TODO: Show a toast to tell the user something went wrong with saving post
                Toast.makeText(this, "Post was not saved! Please try again.", Toast.LENGTH_SHORT).show()

            } else {
                Log.i(TAG, "Successfully saved post")
                // TODO: Resetting the EditText field to be empty
                post.setDescription("")
                //TODO: Rest the ImageView to empty
            }
        }
    }
